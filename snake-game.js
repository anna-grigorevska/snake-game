...
// Задаем направление движения змейки на основе нажатой клавиши
...
Apple.prototype.move  = function(occupiedBlock) {
  ...
  let index = occupiedBlock.length - 1;
  while(index >= 0) {
    if(this.position.equal(occupiedBlock[index])) {
